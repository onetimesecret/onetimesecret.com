...
| `pnpm edge:error-page:push` | Push the regional error page to Bunny (`--help`) |
...
https://github.com/marketplace/actions/bunnycdn-gh-action
https://github.com/radenpioneer/astro-check
