...
<template>
  <header class="absolute inset-x-0 top-0 z-50">
    ...
    <Dialog
      ...
      id="mobile-menu"
    >
      <div class="fixed inset-0 z-50 bg-gray-500/75 dark:bg-gray-900/80" aria-hidden="true" />
      <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white dark:bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:sm:ring-gray-100/10">
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10 dark:divide-gray-500/30">
            ...
            <div class="py-6 flex items-center">
              <span class="text-sm font-medium text-gray-700 dark:text-gray-300 mr-3">Toggle theme:</span>
              <DarkModeToggle />
            </div>
          </div>
        </div>
