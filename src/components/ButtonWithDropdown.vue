<!-- src/components/ButtonWithDropdown.vue -->
...
defineProps({
  ...
  dropdownClass: {
    type: String,
    default:
      "relative inline-flex items-center rounded-r-md bg-white px-2 py-2 text-gray-400 ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus:z-10",
  },
});
</script>
...
<template>
  <div class="inline-flex rounded-md shadow-xs">
    ...
    >
      <MenuButton :class="dropdownClass">
