                ...
                <div v-for="tier in tiers"
                  ...
                  <div>
                    ...
                    <div class="mt-4 flex items-baseline gap-x-2">
                      <span
                            class="font-brand text-5xl font-bold tracking-tight text-gray-900 dark:text-white">{{ getPrice(tier) }}</span>
                      <span
                            class="font-brand text-base font-semibold leading-7 text-gray-600 dark:text-gray-400">{{ frequency.priceSuffix }}</span>
                    </div>
