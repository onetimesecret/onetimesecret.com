...
<template>
<div
  class="w-full bg-brand-50 dark:bg-brand-800 border-b border-brand-200 dark:border-brand-700 sticky top-0 left-0 right-0 z-[100]">
  <div class="mx-auto max-w-7xl px-3 py-3 sm:px-6 lg:px-8">
    <div class="flex flex-wrap items-center justify-between">
      ...
      <div
        ...
        <!-- TODO: Re-enable region-switch CTA when domain routing is implemented -->
        <!--<button
          type="button"
          class="flex items-center justify-center rounded-md border border-transparent bg-brand-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-brand-700 dark:bg-brand-700 dark:hover:bg-brand-600 focus-visible:outline-2 focus-visible:outline-brand-500 focus-visible:outline-offset-2 dark:focus-visible:outline-offset-brand-800"
