// src/components/vue/icons/meta.ts
...
export const iconLibraries: Record<string, IconLibraryMeta> = {
  ...
  heroicons: {
    ...
    license: "MIT",
    licenseUrl:
      "https://github.com/tailwindlabs/heroicons/blob/d84ffa5/LICENSE",
  ...
  materialSymbols: {
    ...
    license: "Apache 2.0",
    licenseUrl:
      "https://github.com/material-icons/material-icons/blob/fae3760/LICENSE",
