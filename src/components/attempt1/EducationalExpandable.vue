...
<template>
  <div class="w-full rounded-lg border border-gray-200 bg-white shadow-sm my-4">
    <Disclosure v-slot="{ open }" :defaultOpen="defaultOpen" as="div">
      <DisclosureButton
        ...
        :class="{
          ...
          'bg-emerald-50 text-emerald-800': type === 'tip',
          'rounded-b-lg': !open
        }"
        @click="trackExpand"
      >
      ...
      <DisclosurePanel class="px-4 pt-4 pb-5 text-sm text-gray-700">
        <slot>
