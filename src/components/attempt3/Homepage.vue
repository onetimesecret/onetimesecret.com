  ...
  <main class="bg-gray-50">
    ...
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div class="text-center">
        ...
        <!-- Region indicator -->
        <div class="mx-auto mt-4 flex max-w-md items-center justify-center space-x-2 text-sm text-gray-500">
          <span>{{ t("web.secrets.securelyStored") || "Securely stored in" }}</span>
          <div class="inline-flex items-center rounded-md bg-white px-2.5 py-0.5 text-sm font-medium text-gray-700 border border-gray-200">
